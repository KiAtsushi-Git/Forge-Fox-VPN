...
///
/// Used by the split-tunnel engine to learn IPs behind `domain` / `domain_zone`
/// rules as they are resolved, instead of relying on a single up-front lookup
/// (CDNs rotate addresses constantly).
